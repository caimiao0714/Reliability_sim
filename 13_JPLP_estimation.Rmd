...
```{r}
dt_stan = list(N = nrow(dt$event_time),
               S = nrow(dt$trip_time),
               r_trip = dt$trip_time$trip_id,
               t_trip_start = dt$trip_time$t_trip_start,
               t_trip_end = dt$trip_time$t_trip_end,
               event_time = dt$event_time$event_time,
               group_size = dt$trip_time$N_events)
```
